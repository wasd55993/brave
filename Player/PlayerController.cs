...
public class PlayerController : MonoBehaviourPun
{
    ...
    {
        inputcontrol.Enable();
        loadScene.LoadRequstEvent += OnLoadRequstEvent;
        cameraEvent.OnEventRaised += afterLoadScene;
    }
    ...
    //事件执行方法
    private void OnLoadRequstEvent(GameSceneSO arg0, Vector3 arg1, bool arg2)
    {
